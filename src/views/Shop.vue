              ...
              <div class="checkbox-filter">
                <div class="checkbox">
                  <label class="checkbox_control">
                    ...
                    <span class="checkbox_label">24小時到府</span>
                  </label>
                </div>
              </div>
              <div class="checkbox-filter">
                <div class="checkbox">
                  <label class="checkbox_control">
                    ...
                    <span class="checkbox_label">宅配到府</span>
                  </label>
                </div>
              </div>
              <div class="checkbox-filter">
                <div class="checkbox">
                  <label class="checkbox_control">
                    ...
                    <span class="checkbox_label">超商取貨</span>
                  </label>
                </div>
              </div>
            </div>
              ...
              <div class="checkbox-filter">
                <div class="checkbox">
                  <label class="checkbox_control">
                    ...
                    <span class="checkbox_label">禮盒</span>
                  </label>
                </div>
              </div>
              <div class="checkbox-filter">
                <div class="checkbox">
                  <label class="checkbox_control">
                    ...
                    <span class="checkbox_label">促銷商品</span>
                  </label>
                </div>
              </div>
              <div class="checkbox-filter">
                <div class="checkbox">
                  <label class="checkbox_control">
                    ...
                    <span class="checkbox_label">即將放送</span>
                  </label>
                </div>
              </div>
              <div class="checkbox-filter">
                <div class="checkbox">
                  <label class="checkbox_control">
                    ...
                    <span class="checkbox_label">加工產品</span>
                  </label>
                </div>
              </div>
              <div class="checkbox-filter">
                <div class="checkbox">
                  <label class="checkbox_control">
                    ...
                    <span class="checkbox_label">果乾</span>
                  </label>
                </div>
              </div>
              <div class="checkbox-filter">
                <div class="checkbox">
                  <label class="checkbox_control">
                    ...
                    <span class="checkbox_label">新鮮水果</span>
                  </label>
                </div>
              </div>
              <div class="checkbox-filter">
                <div class="checkbox">
                  <label class="checkbox_control">
                    ...
                    <span class="checkbox_label">有機水果</span>
                  </label>
                </div>
              </div>
            </div>
